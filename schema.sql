...
-- - words: English headwords and expressions
-- - definitions: Vietnamese definitions and grammatical parts of speech
-- - word_definitions: Links between words and definitions with example sentences
-- - pronunciations: IPA pronunciations for words

-- ============================================================================
-- WORDS TABLE
-- ============================================================================
-- Stores English headwords, phrases, and idioms
...
--   lang_code: Language code (standardized to 'en' for English entries)
--
-- Constraints & Indexes:
...
--   pos: Part of speech (N: noun, V: verb, A: adjective, D: adverb, idiom, etc.)
...
-- ============================================================================
-- Maps words to definitions with learner-friendly example sentences
...
--   example: Full example sentence using the exact word/phrase
--
-- Indexes:
--   idx_word_definitions_word_id: For efficient word lookups
--   idx_word_definitions_definition_id: For efficient reverse definition lookups
...
--   region: Pronunciation region/dialect (e.g., 'BrE', 'NAmE', 'UK', 'US')
--
-- Constraints & Indexes:
--   idx_pronunciations_word_id: For fast word lookups
--   idx_pronunciations_unique: Composite unique index on (word_id, ipa, region)
...
--
--
-- 3. Get word with all information (IPA, definitions, examples):
--
--    SELECT
--      w.word,
--      p.ipa,
...
--
--
-- 4. Search words by prefix (Autocomplete):
--
